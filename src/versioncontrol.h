...
{
    constexpr auto firstPartStartValid  = static_cast<int>(JSAccountResourcesExceededErr) == static_cast<int>(NatsMq::JsError::AccountResourcesExceededErr);
    constexpr auto firstPartEndValid    = static_cast<int>(JSStreamInvalidErr) == static_cast<int>(NatsMq::JsError::StreamInvalidErr);
    constexpr auto secondPartStartValid = static_cast<int>(JSConsumerWQRequiresExplicitAckErr) == static_cast<int>(NatsMq::JsError::ConsumerWQRequiresExplicitAckErr);
    constexpr auto secondPartEndValid   = static_cast<int>(JSStreamInfoMaxSubjectsErr) == static_cast<int>(NatsMq::JsError::StreamInfoMaxSubjectsErr);
